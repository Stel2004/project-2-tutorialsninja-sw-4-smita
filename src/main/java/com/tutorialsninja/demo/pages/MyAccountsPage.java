...
public class MyAccountsPage extends Utility {
    ...
    public void enterFirstName() {
        sendTextToElement(firstName, "Smita");
    }

    public void enterLastName() {
        sendTextToElement(lastName, "Vaja");
    }

    public void enterEMail() {
        //sendTextToElement(emailId , "Smitavaja@gmail.com");
        generateRandomEmail(emailId, "Smitavaja@gmail.com");
    }
